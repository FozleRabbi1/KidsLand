...
const InformationSection = () => {
  ...
  useEffect(() => {
    ...
    return (
        ...
        <div className="px-1 overflow-hidden pb-5 md:py-20 lg:py-36 md:mt-0 main-info-div grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-center gap-10 z-10">
