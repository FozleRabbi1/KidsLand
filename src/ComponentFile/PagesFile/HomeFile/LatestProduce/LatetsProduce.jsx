...
const LatetsProduce = () => {
    return (
        <div>
            ...
            <div className='latest-product-main-div py-10 grid grid-cols-2 gap-x-10 items-center'>

                <div class="container  grid grid-cols-2">

                    <div class="card_box w-6/12">
                        <span></span>
                    ...
                    <div className='5/12 p-1 mt-10 ps-3'>
                        ...
                        <p className=''>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quisquam hic corporis nostrum incidunt amet maiores.</p>

                        <div data-tooltip="Price:-$40" class="button mt-3">
                ...
                <div class="container  grid grid-cols-2">
                    ...
                    <div className='5/12 p-1 mt-10 ps-3'>
                        ...
                        <div data-tooltip="Price:-$45" class="button mt-3">
                            <div class="button-wrapper">
                                <div class="text">Buy Now</div>
                                <span class="icon">
                                    <svg viewBox="0 0 16 16" class="bi bi-cart2" fill="currentColor" height="16" width="16" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="container  grid grid-cols-2">
                    ...
                    <div className='5/12 p-1 mt-10 ps-3'>
                        ...
                        <div data-tooltip="Price:-$65" class="button mt-3">
                            <div class="button-wrapper">
                                <div class="text">Buy Now</div>
                                <span class="icon">
                                    <svg viewBox="0 0 16 16" class="bi bi-cart2" fill="currentColor" height="16" width="16" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="container  grid grid-cols-2">
                    ...
                    <div className='5/12 p-1 mt-10 ps-3'>
                        <h2 >Lorem ipsum, dolor sit amet consectetur</h2>
                        <p className=''>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quisquam hic corporis nostrum incidunt amet maiores.</p>
                        <div data-tooltip="Price:-$20" class="button mt-3">
                            <div class="button-wrapper">
                                <div class="text">Buy Now</div>
                                <span class="icon">
                                    <svg viewBox="0 0 16 16" class="bi bi-cart2" fill="currentColor" height="16" width="16" xmlns="http://www.w3.org/2000/svg">
